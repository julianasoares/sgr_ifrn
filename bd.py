...
#Pessoas
pes1=Pessoa(is_staff=True,first_name='Givanaldo Rocha',cpf='33344455560',email='givanaldo@gmail.com',data_nascimento="1973-05-30", telefone='8499253259' ,username='20122148000001')
pes1.set_password('123456')
pes1.save()
pes2=Pessoa(first_name='Alvaro Hermano',cpf='33344455561',email='alvaro@gmail.com',data_nascimento="1976-03-22",username='20122148000002',  telefone='84955556661')
pes2.set_password('123456')
pes2.save()
pes3=Pessoa(first_name='Luiz Ricardo',cpf='33344955562',email='luiz@gmail.com',data_nascimento="1975-08-12",username='20122148000003', telefone='84955556662')
pes3.set_password('123456')
pes3.save()
pes4=Pessoa(first_name='Bruno Gomes Gurgel',cpf='33344455563',email='bruno@gmail.com',data_nascimento="1973-05-30",username='20122148000004',  telefone='84955556663')
pes4.set_password('123456')
pes4.save()
pes5=Pessoa(first_name='Diogenes Henrique Silva',cpf='33344455564',email='diogenes@gmail.com',data_nascimento="1976-03-22",username='20122148000005', telefone='84955556664')
pes5.set_password('123456')
pes5.save()
pes6=Pessoa(first_name='Bartolomeu Silva Borges',cpf='33344455565',email='bartolomeu@gmail.com',data_nascimento="1975-03-19",username='20122148000006',telefone='84955556665')
pes6.set_password('123456')
pes6.save()
pes7=Pessoa(first_name='Silvia Araújo de Lima',cpf='33344455566',email='silvia@gmail.com',data_nascimento="1973-05-30",username='20122148000007', telefone='84955556666')
pes7.set_password('123456')
pes7.save()
pes8=Pessoa(first_name='Renata Cavalcanti Pereira',cpf='33344455567',email='renata@gmail.com',data_nascimento="1976-03-22",username='20122148000008', telefone='84955556667')
pes8.set_password('123456')
pes8.save()
pes9=Pessoa(first_name='Hugo Limeira da Silva',cpf='33344455568',email='hugo@gmail.com',data_nascimento="1975-08-12",username='20122148000009',  telefone='84955556668')
pes9.set_password('123456')
pes9.save()
pes10=Pessoa(first_name='Fernando Barcelar Gomes',cpf='33344455569',email='fernando@gmail.com',data_nascimento="1978-05-30",username='20122148000010', telefone='84955556669')
pes10.set_password('123456')
pes10.save()
pes11=Pessoa(first_name='Isaú Lopes Sousa',cpf='33344455570',email='isau@gmail.com',data_nascimento="1976-03-22",username='20122148000011', telefone='84955556670')
pes11.set_password('123456')
pes11.save()
pes12=Pessoa(first_name='Otávio Moreira Cardoso',cpf='33344455571',email='otavio@gmail.com',data_nascimento="1975-08-12",username='20122148000012', telefone='84955556671')
pes12.set_password('123456')
pes12.save()
pes13=Pessoa(first_name='Júlio Hermano Pires',cpf='33344455572',email='julio@gmail.com',data_nascimento="1970-09-12",username='20122148000013',  telefone='84955556672')
pes13.set_password('123456')
pes13.save()
pes14=Pessoa(first_name='Claudio Pereira Vasconcelos',cpf='33344455573',email='claudio@gmail.com',data_nascimento="1975-04-30",username='20122148000014', telefone='84955556673')
pes14.set_password('123456')
pes14.save()
pes15=Pessoa(first_name='Tadeu Viera de Sousa',cpf='33344455574',email='tadeu@gmail.com',data_nascimento="1973-07-18",username='20122148000015', telefone='84955556674')
pes15.set_password('123456')
pes15.save()
pes16=Pessoa(first_name='João Maria de Lima',cpf='33344455575',email='joaogmail.com',data_nascimento="1973-07-21",username='20122148000016', telefone='84952956674')
pes16.set_password('123456')
pes16.save()
pes17=Pessoa(first_name='Valdemiro Júnior',cpf='33344455576',email='valdemirogmail.com',data_nascimento="1970-09-14",username='20122148000017', telefone='84962956874')
pes17.set_password('123456')
pes17.save()
pes18 = Pessoa(first_name='Felipe Quintaes',cpf='22259844456',email='felipe@gmail.com',data_nascimento="1979-02-20",username='20112148000018', telefone='84977776666')
pes18.set_password('123456')
pes18.save()
pes19=Pessoa(first_name='Eduardo Chavez',cpf='55566633301',email='eduardo@gmail.com',data_nascimento="1989-05-15",username='20112133010219',  telefone='84955196660')
pes19.set_password('123456')
pes19.save()
pes20=Pessoa(first_name='Ana Paula',cpf='55566633302',email='ana@gmail.com',data_nascimento="1986-09-22",username='2011213301020', telefone='84956286660')
...
#Alunos
al1=Aluno(first_name='Luan Medeiros Macena',cpf='77788818001',email='luan@gmail.com',data_nascimento="1992-02-22",username='20142144060201',telefone='84955186660', curso=cur1)
al1.set_password('123456')
al1.save()
al2=Aluno(first_name='Carlos Henrique Pires',cpf='77788818002',email='carlos@gmail.com',data_nascimento="1990-05-30",username='20142144060202',telefone='84954956660', curso=cur1)
al2.set_password('123456')
al2.save()
al3=Aluno(first_name='Juliana Soares dos Anjos',cpf='77788818003',email='juliana@gmail.com',data_nascimento="1995-04-08",username='20142144060203',telefone='84955266660', curso=cur1)
al3.set_password('123456')
al3.save()
al4=Aluno(first_name='Matheus Barbosa de Farias',cpf='77788818004',email='matheus@gmail.com',data_nascimento="1994-06-14",username='20142144060204',telefone='84955557160', curso=cur1)
al4.set_password('123456')
al4.save()
al5=Aluno(first_name='Hallesandro Dvilla',cpf='77788818005',email='hallesandro@gmail.com',data_nascimento="1995-03-30",username='20142144060205',telefone='84955166660', curso=cur1)
al5.set_password('123456')
al5.save()
al6=Aluno(first_name='Ednilson Palhares',cpf='77788818006',email='ednilson@gmail.com',data_nascimento="1992-09-21",username='20142144060206',telefone='84905556660', curso=cur1)
al6.set_password('123456')
al6.save()
al7=Aluno(first_name='Wellignton Ferreira',cpf='77788818007',email='wellignton@gmail.com',data_nascimento="1994-04-13",username='20142144060207',telefone='84959556660', curso=cur1)
al7.set_password('123456')
al7.save()
al8=Aluno(first_name='Monic Laura',cpf='77788818008',email='monic@gmail.com',data_nascimento="1993-06-30",username='20142144060208',telefone='84955555660', curso=cur1)
