...
class Requerimento(models.Model):
    ...
    resultado_certificacao = models.NullBooleanField("Resultado", default=None)
    ...
    resultado = models.NullBooleanField("Resultado", blank=True, null=True, default=None)
    ...
    apto_avaliacao = models.NullBooleanField("Apto para avalição", default=None)
